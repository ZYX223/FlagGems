...
@pytest.mark.parametrize(
    "precision,supported_modes,expected_mode",
    [
        ("highest", ("highest", "high", "medium"), 0),
        ("high", ("highest", "high", "medium"), 1),
        ("medium", ("highest", "high", "medium"), 2),
        ("high", ("highest", "medium"), 0),
        ("medium", ("highest", "medium"), 2),
        ("medium", ("highest", "high"), 1),
        ("high", ("highest",), 0),
        ("medium", ("highest",), 0),
    ],
)
def test_resolve_fp32_dot_mode(precision, supported_modes, expected_mode):
    from flag_gems.runtime.backend.backend_utils import resolve_fp32_dot_mode

    assert resolve_fp32_dot_mode(precision, supported_modes) == expected_mode
